...
class PatientsApi {
  ...
  ///
  /// 
  Future<Response<ChangeStatusAmbuPatientResponse>> patientsChangeStatusIdUserIdPatch({ 
    required String id,
    ...
    final _path = r'/patients/change-status/{id}/{userId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// 
  Future<Response<ChangeStatusAmbuPatientResponse>> patientsIdStretcherDeliverUserIdPatch({ 
    required String id,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/patients/{id}/stretcher-deliver/{userId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// 
  Future<Response<ChangeStatusAmbuPatientResponse>> patientsIdStretcherTakeUserIdPatch({ 
    required String id,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/patients/{id}/stretcher-take/{userId}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<FindOneAmbuPatientResponse>> patientsIdUserIdGet({ 
    ...
    FindOneAmbuPatientResponse _responseData;

    try {
      const _responseType = FullType(FindOneAmbuPatientResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as FindOneAmbuPatientResponse;
    ...
    return Response<FindOneAmbuPatientResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UpdateAmbuPatientResponse>> patientsIdUserIdPatch({ 
    ...
    try {
      const _type = FullType(UpdateAmbuPatientRequest);
      _bodyData = updateAmbuPatientRequest == null ? null : _serializers.serialize(updateAmbuPatientRequest, specifiedType: _type);
  ...
  Future<Response<CreateAmbuPatientResponse>> patientsUserIdPost({ 
    ...
    try {
      const _type = FullType(CreateAmbuPatientRequest);
      _bodyData = createAmbuPatientRequest == null ? null : _serializers.serialize(createAmbuPatientRequest, specifiedType: _type);
    ...
    CreateAmbuPatientResponse _responseData;

    try {
      const _responseType = FullType(CreateAmbuPatientResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as CreateAmbuPatientResponse;
    ...
    return Response<CreateAmbuPatientResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
